...
# this file is just a copy of the cli.py that i can modify without fucking up anything
...
def create_replay_memory_dataset() -> None:
    ...
    bot_3_behaviour: Bot = RdeepBot(5, 4, 54354)
    bot_4_behaviour: Bot = MLPlayingBot(13421)
    ...
    replay_memory_recording_bot_3 = MLDataBot(bot_3_behaviour, replay_memory_location=replay_memory_location)
    replay_memory_recording_bot_4 = MLDataBot(bot_4_behaviour, replay_memory_location=replay_memory_location)
    for i in range(1, num_of_games + 1):
        ...
        engine.play_game(replay_memory_recording_bot_1, replay_memory_recording_bot_4, random.Random(i))
...
print(create_replay_memory_dataset())